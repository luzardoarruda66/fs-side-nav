        ...
        <div className="search-Dialog">
            <div className="lateral-search-Dialog">
                ...
                <div className="lateral-search-filters">
                    ...
                    <label className="checkbox-lateral-search">
                        <input type="radio" onChange={filterRadio} value="Relevancia" name="orderby" className="lateral-search-radio" />
                        Relevância
                    </label>
                    <label className="checkbox-lateral-search">
                        <input type="radio" onChange={filterRadio} value="Recentes" name="orderby" className="lateral-search-radio" />
                        Recentes
                    </label>
                    <label className="checkbox-lateral-search">
                        <input type="radio" onChange={filterRadio} value="A-Z" name="orderby" className="lateral-search-radio" />
                        A-Z
                    </label>
                    ...
                    {zones ? zones.map((zone) => {
                        return (
                            <label className="checkbox-lateral-search">
                                <input type="radio" name="zoneFilter" onChange={onZoneFilter} value={zone.Id} className="lateral-search-radio" />
                                {zone.Title}
                            </label>
                        )
                    }) : null}
            ...
            <div className="principal-content-search">
                ...
                <div className="items-result-search">
                    {zoneData ? searchText ? zoneData.filter(item => item.FileLeafRef.includes(searchText)).map((item, index) => {
                        return (
